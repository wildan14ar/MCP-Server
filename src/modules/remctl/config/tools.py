...
def tool(name: str = None, description: str = None):
    ...
    Auto-hides config params: host, user, password, pkey_str, port
    """
    CONFIG_PARAMS = {'host', 'user', 'password', 'pkey_str', 'port'}
...
class ToolsManager:
    ...
    def auto_discover_tools(self):
        ...
        for module_name in self.discover_tool_modules():
            module_path = f"src.modules.remctl.tools.{module_name}"
            try:
